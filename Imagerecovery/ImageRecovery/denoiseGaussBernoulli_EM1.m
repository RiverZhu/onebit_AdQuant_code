function [mout, vout,  muout, piout, sigvarout] = denoiseGaussBernoulli_EM1(rhat, vr, pi0, mu0, sigvar0)
% This function is to implement signal denoising and EM learning.
