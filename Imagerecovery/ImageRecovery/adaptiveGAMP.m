function [ xhat, vx ] = adaptiveGAMP( A, z, vx0, xhat0, pi0, mu0, sigvar0, Delta0, T, noise)
% This function is to implement the GAMP-EM-AD.
...
[xhat, vx] = GampEM1( A(1:minit, :), y, tauinit, vx0, xhat0, pi0, mu0, sigvar0, Delta0, T);
...
while(mhigh <= m)
    ...
    % Reconstruct
    [xhat, vx] = GampEM1( A(1:mhigh, :), y, tau, vx0, xhat0, pi0, mu0, sigvar0, Delta0, T);
...
if(mlow <= m)
    ...
    % Reconstruct
    [xhat, vx] = GampEM1( A, y, tau, vx0, xhat0, pi0, mu0, sigvar0, Delta0, T);
