function [xhat, vx] = GampEM1( A, y, tau, vx0, xhat0, pi0, mu0, sigvar0, Delta0, T)
% This function includes:
% (1) GAMP algorithm for one bit compressed sensing .
% (2) EM learning for system parameters without NNSPL method.
...
for t = 1:T
    ...
    [xhat, vx,  mu0, pi0, sigvar0] = denoiseGaussBernoulli_EM1(rhat, vr, pi0, mu0, sigvar0);
